...
Aktualizacja v8.2.20: PogromcaKwiatkow.py -> v8.1.0 (nowa warstwa
raportu RYZYKO-KLUCZA - patrz README Historia zmian). v8.2.19: ZagladaKultury.py -> v1.1.1 (naprawa desynchronizacji
stanu cudzyslowow w awaryjnym skanerze, znaleziona absurdalnym testem
samo-atakujacym - patrz README Historia zmian). Nowe narzedzie:
dev/turnieje/SUMA-KONTROLNA-TESTOW.py (mechanizm zlotego pliku).
v8.2.18: ZagladaKultury.py -> v1.1.0 (naprawa spojnosci
identyfikatorow, znaleziona turniejem zewnetrznym - patrz README Historia
zmian i docs/CERTYFIKAT-PEWNIAKA-ZAGLADA-v1.1.0.md). Stary certyfikat
v1.0.9 oznaczony jako superseded, zostaje jako zapis historyczny. Audyt
linkow: 47/47 sprawdzonych, 0 zerwanych (2 naprawione podczas audytu).
v8.2.17: dodany docs/CERTYFIKAT-PEWNIAKA-ZAGLADA-v1.0.9.md
...
| [README.md](../README.md) | 17905 B | `96e2a45aa197` |
